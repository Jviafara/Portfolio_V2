...
const About = () => {
    return (
        <div
            ...
            <div className='max-w-screen-lg px-4 md:p-8 mx-auto my-10 flex flex-col gap-10 justify-center w-full h-full'>
                <UnderLine>
                    <p className='text-4xl font-bold inline border-b-4 border-gray-500'>
                        About Me
                    </p>
                </UnderLine>
                <div className='flex flex-col gap-4 text-justify text'>
                    <p className='text-xl'>
                        Hello,I&aposm an enthusiastic and dedicated full stack
                        developer more than a year of experience and passion for
