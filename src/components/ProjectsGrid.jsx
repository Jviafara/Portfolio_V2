  ...
  const projects = [
    {
      ...
      liveDemo: 'https://movie-nest-nextjs.vercel.app/',
            ...
            <div className='flex-grow w-full lg:w-1/2 flex flex-col justify-start gap-8'>
              ...
              <div className='flex items-center justify-evenly gap-2 p-4'>
                {project[0].techs.map(tech => (
                  ...
                  >
                    ...
                    <p className='hidden group-hover:flex'>{tech.toUpperCase()}</p>
                  </div>
                ))}
              </div>
              <div className='w-full flex  justify-center gap-8'>
                <a
                  ...
                  target='_blank'
                  rel='noreferrer'
                  className='w-1/3 px-4 py-3 shadow-md shadow-gray-600 rounded-lg duration-300 hover:scale-110'
                >
                  Live Demo
                </a>
                <a
                  ...
                  target='_blank'
                  rel='noreferrer'
                  className='w-1/3 px-6 py-3 shadow-md shadow-gray-600 rounded-lg duration-300 hover:scale-110'
                >
                  Code
                </a>
              </div>
            ...
            <div className='hidden w-1/3 lg:flex flex-col pl-4'>
              ...
              <div>
                {project[0].bulletPoints?.length > 0 &&
                  project[0].bulletPoints.map((item, index) => (
                    <div key={index}>
                      <h1>
                        <span>• </span>
                        {item}
